...
set game=src\collision_behavior\collision_behavior.c src\player_helpers\player_helpers.c src\enemy_helpers\enemy_helpers.c src\map_helpers\map_helpers.c src\weapon_types\weapon_types.c src\hud\hud.c src\menu_helpers\menu_helpers.c
