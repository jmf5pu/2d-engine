...
void player_on_hit(Body *self, Body *other, Hit hit)
{
    ...
    {
        printf("bullet collision detected\n");
        player->health -= 50;     // other_player->weapon->damage; // TODO: eventually may need to attach this value to a bullet struct
    ...
    else if (other->collision_layer == COLLISION_LAYER_PICKUP && other->is_active && self->is_active)
    {
        ...
        player->weapon->current_capacity = 100;
