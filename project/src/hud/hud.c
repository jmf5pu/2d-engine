...
void init_health_anims(void)
{
    ...
    render_sprite_sheet_init(
        ...
        "assets/hud/health_cross_10.png",
        100,
        100);
    ...
    render_sprite_sheet_init(
        ...
        "assets/hud/health_cross_11.png",
        100,
        100);
    ...
    render_sprite_sheet_init(
        ...
        "assets/hud/health_cross_12.png",
        100,
        100);
    ...
    render_sprite_sheet_init(
        ...
        "assets/hud/health_cross_13.png",
        100,
        100);
    ...
    render_sprite_sheet_init(
        ...
        "assets/hud/health_cross_14.png",
        100,
        100);
...
{
    render_sprite_sheet_init(
        &sprite_sheet_ammo_0, "assets/hud/0.png", DIGIT_WIDTH, DIGIT_HEIGHT);
    adef_ammo_0 = animation_definition_create(
        &sprite_sheet_ammo_0, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    anim_ammo_0 = animation_create(adef_ammo_0, false);

    render_sprite_sheet_init(
        &sprite_sheet_ammo_1, "assets/hud/1.png", DIGIT_WIDTH, DIGIT_HEIGHT);
    adef_ammo_1 = animation_definition_create(
        &sprite_sheet_ammo_1, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    anim_ammo_1 = animation_create(adef_ammo_1, false);

    render_sprite_sheet_init(
        &sprite_sheet_ammo_2, "assets/hud/2.png", DIGIT_WIDTH, DIGIT_HEIGHT);
    adef_ammo_2 = animation_definition_create(
        &sprite_sheet_ammo_2, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    anim_ammo_2 = animation_create(adef_ammo_2, false);

    render_sprite_sheet_init(
        &sprite_sheet_ammo_3, "assets/hud/3.png", DIGIT_WIDTH, DIGIT_HEIGHT);
    adef_ammo_3 = animation_definition_create(
        &sprite_sheet_ammo_3, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    anim_ammo_3 = animation_create(adef_ammo_3, false);

    render_sprite_sheet_init(
        &sprite_sheet_ammo_4, "assets/hud/4.png", DIGIT_WIDTH, DIGIT_HEIGHT);
    adef_ammo_4 = animation_definition_create(
        &sprite_sheet_ammo_4, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    anim_ammo_4 = animation_create(adef_ammo_4, false);

    render_sprite_sheet_init(
        &sprite_sheet_ammo_5, "assets/hud/5.png", DIGIT_WIDTH, DIGIT_HEIGHT);
    adef_ammo_5 = animation_definition_create(
        &sprite_sheet_ammo_5, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    anim_ammo_5 = animation_create(adef_ammo_5, false);

    render_sprite_sheet_init(
        &sprite_sheet_ammo_6, "assets/hud/6.png", DIGIT_WIDTH, DIGIT_HEIGHT);
    adef_ammo_6 = animation_definition_create(
        &sprite_sheet_ammo_6, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    anim_ammo_6 = animation_create(adef_ammo_6, false);

    render_sprite_sheet_init(
        &sprite_sheet_ammo_7, "assets/hud/7.png", DIGIT_WIDTH, DIGIT_HEIGHT);
    adef_ammo_7 = animation_definition_create(
        &sprite_sheet_ammo_7, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    anim_ammo_7 = animation_create(adef_ammo_7, false);

    render_sprite_sheet_init(
        &sprite_sheet_ammo_8, "assets/hud/8.png", DIGIT_WIDTH, DIGIT_HEIGHT);
    adef_ammo_8 = animation_definition_create(
        &sprite_sheet_ammo_8, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    anim_ammo_8 = animation_create(adef_ammo_8, false);

    render_sprite_sheet_init(
        &sprite_sheet_ammo_9, "assets/hud/9.png", DIGIT_WIDTH, DIGIT_HEIGHT);
    adef_ammo_9 = animation_definition_create(
        &sprite_sheet_ammo_9, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    anim_ammo_9 = animation_create(adef_ammo_9, false);

    render_sprite_sheet_init(
        &sprite_sheet_ammo_0_blinking,
        "assets/hud/0_blinking.png",
        DIGIT_WIDTH,
        DIGIT_HEIGHT);
    ...
    render_sprite_sheet_init(
        &sprite_sheet_ammo_1_blinking,
        "assets/hud/1_blinking.png",
        DIGIT_WIDTH,
        DIGIT_HEIGHT);
    ...
    render_sprite_sheet_init(
        &sprite_sheet_ammo_2_blinking,
        "assets/hud/2_blinking.png",
        DIGIT_WIDTH,
        DIGIT_HEIGHT);
    ...
    render_sprite_sheet_init(
        &sprite_sheet_ammo_3_blinking,
        "assets/hud/3_blinking.png",
        DIGIT_WIDTH,
        DIGIT_HEIGHT);
    ...
    render_sprite_sheet_init(
        &sprite_sheet_ammo_4_blinking,
        "assets/hud/4_blinking.png",
        DIGIT_WIDTH,
        DIGIT_HEIGHT);
    ...
    render_sprite_sheet_init(
        &sprite_sheet_ammo_5_blinking,
        "assets/hud/5_blinking.png",
        DIGIT_WIDTH,
        DIGIT_HEIGHT);
    ...
    render_sprite_sheet_init(
        &sprite_sheet_ammo_6_blinking,
        "assets/hud/6_blinking.png",
        DIGIT_WIDTH,
        DIGIT_HEIGHT);
    ...
    render_sprite_sheet_init(
        &sprite_sheet_ammo_7_blinking,
        "assets/hud/7_blinking.png",
        DIGIT_WIDTH,
        DIGIT_HEIGHT);
    ...
    render_sprite_sheet_init(
        &sprite_sheet_ammo_8_blinking,
        "assets/hud/8_blinking.png",
        DIGIT_WIDTH,
        DIGIT_HEIGHT);
    ...
    render_sprite_sheet_init(
        &sprite_sheet_ammo_9_blinking,
        "assets/hud/9_blinking.png",
        DIGIT_WIDTH,
        DIGIT_HEIGHT);
    ...
    vec4 color)
{
    ...
    if (health == 100) {
        animation_render(
            anim_health_cross_0, window, position, 0, color, texture_slots);
    }
    else if (health > 93) {
        animation_render(
            anim_health_cross_1, window, position, 0, color, texture_slots);
    }
    else if (health > 86) {
        animation_render(
            anim_health_cross_2, window, position, 0, color, texture_slots);
    }
    else if (health > 79) {
        animation_render(
            anim_health_cross_3, window, position, 0, color, texture_slots);
    }
    else if (health > 72) {
        animation_render(
            anim_health_cross_4, window, position, 0, color, texture_slots);
    }
    else if (health > 65) {
        animation_render(
            anim_health_cross_5, window, position, 0, color, texture_slots);
    }
    else if (health > 58) {
        animation_render(
            anim_health_cross_6, window, position, 0, color, texture_slots);
    }
    else if (health > 51) {
        animation_render(
            anim_health_cross_7, window, position, 0, color, texture_slots);
    }
    else if (health > 44) {
        animation_render(
            anim_health_cross_8, window, position, 0, color, texture_slots);
    }
    else if (health > 37) {
        animation_render(
            anim_health_cross_9, window, position, 0, color, texture_slots);
    }
    else if (health > 30) {
        animation_render(
            anim_health_cross_10, window, position, 0, color, texture_slots);
    }
    else if (health > 23) {
        animation_render(
            anim_health_cross_11, window, position, 0, color, texture_slots);
    }
    else if (health > 16) {
        animation_render(
            anim_health_cross_12, window, position, 0, color, texture_slots);
    }
    else if (health > 0) {
        animation_render(
            anim_health_cross_13, window, position, 0, color, texture_slots);
    }
    else if (health <= 0) {
        animation_render(
            anim_health_cross_14, window, position, 0, color, texture_slots);
    }
}

// renders the ammo display digit and returns the updated value for calculating
// the next position
u16 render_ammo_digit(
    SDL_Window *window,
    u32 texture_slots[32],
    vec2 position,
    vec4 color,
    ...
    vec4 color)
{
    ...
    while (reserve_digits < 3) {
        animation_render(
            anim_ammo_0, window, position, 0, color, texture_slots);
        position[0] -= DIGIT_WIDTH;
        reserve_digits++;
    }
    // add slash in between reserve and capacity
    animation_render(
        anim_forward_slash, window, position, 0, color, texture_slots);
    position[0] -= DIGIT_WIDTH;
    // repeat logic for capacity attribute
    while (capacity > 0) {
        capacity = render_ammo_digit(
            window,
            texture_slots,
            position,
            color,
            capacity,
            current_ammo_fraction);
        position[0] -= DIGIT_WIDTH;
        capacity_digits++;
    }
    while (capacity_digits < 3) {
        ...
        animation_render(
            current_ammo_fraction <= AMMO_BLINKING_THRESHOLD
...
void init_hud(SDL_Window *window)
{
    ...
    render_sprite_sheet_init(
        &sprite_sheet_divider, "assets/hud/divider.png", 10, 1500);
...
void render_hud(SDL_Window *window, u32 texture_slots[32], vec4 color)
{
    ...
    if (player_one->crosshair->entity->is_active) {
        ...
        f32 x_pos =
            SPLIT_SCREEN
                ? player_one->crosshair->percentage_of_screen[0] *
                      render_width * 0.5
                : player_one->crosshair->percentage_of_screen[0] * render_width;
        f32 y_pos =
            player_one->crosshair->percentage_of_screen[1] * render_height;
        ...
        if (x_pos > (SPLIT_SCREEN ? render_width * 0.5 - crosshair_buffer
            ...
            x_pos =
                (SPLIT_SCREEN ? render_width * 0.5 - crosshair_buffer
                              : render_width - crosshair_buffer);
        ...
        animation_render(
            player_one->crosshair->entity->animation,
            window,
            animation_position,
            0,
            color,
    ...
    render_ammo(
        ...
        player_one,
        (vec2){
            0.5 * DIGIT_WIDTH + DIGIT_WIDTH * 7 + ICON_SPACE,
            0.5 * DIGIT_HEIGHT},
        color);
    ...
    if (SPLIT_SCREEN) {
        ...
        if (player_two->crosshair->entity->is_active) {
            vec2 animation_position;
            f32 x_pos = player_two->crosshair->percentage_of_screen[0] *
                            render_width * 0.5 +
                        render_width * 0.5;
            f32 y_pos =
            ...
            animation_position[1] = y_pos;
            animation_render(
                player_two->crosshair->entity->animation,
                window,
                animation_position,
                0,
                color,
        ...
        render_health(
            ...
            texture_slots,
            player_two,
            (vec2){window_width - 50, window_height - 50},
            color);
        render_ammo(
            window,
            texture_slots,
        ...
        render_sprite_sheet_frame(
            ...
            0,
            false,
            RENDER_PHYSICS_BODIES ? SEMI_TRANSPARENT : color,
            texture_slots);
    }
}
