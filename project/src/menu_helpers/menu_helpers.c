...
void init_menu_anims(void)
{
    ...
    adef_A = animation_definition_create(
        &sprite_sheet_A, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_B = animation_definition_create(
        &sprite_sheet_B, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_C = animation_definition_create(
        &sprite_sheet_C, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_D = animation_definition_create(
        &sprite_sheet_D, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_E = animation_definition_create(
        &sprite_sheet_E, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_F = animation_definition_create(
        &sprite_sheet_F, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_G = animation_definition_create(
        &sprite_sheet_G, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_H = animation_definition_create(
        &sprite_sheet_H, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_I = animation_definition_create(
        &sprite_sheet_I, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_J = animation_definition_create(
        &sprite_sheet_J, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_K = animation_definition_create(
        &sprite_sheet_K, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_L = animation_definition_create(
        &sprite_sheet_L, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_M = animation_definition_create(
        &sprite_sheet_M, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_N = animation_definition_create(
        &sprite_sheet_N, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_O = animation_definition_create(
        &sprite_sheet_O, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_P = animation_definition_create(
        &sprite_sheet_P, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_Q = animation_definition_create(
        &sprite_sheet_Q, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_R = animation_definition_create(
        &sprite_sheet_R, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_S = animation_definition_create(
        &sprite_sheet_S, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_T = animation_definition_create(
        &sprite_sheet_T, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_U = animation_definition_create(
        &sprite_sheet_U, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_V = animation_definition_create(
        &sprite_sheet_V, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_W = animation_definition_create(
        &sprite_sheet_W, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_X = animation_definition_create(
        &sprite_sheet_X, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    adef_Y = animation_definition_create(
        &sprite_sheet_Y, (f32[]){0}, (u8[]){0}, (u8[]){0}, 1);
    ...
    render_sprite_sheet_init(
        ...
        "assets/menus/selected_bracket_right.png",
        62,
        62);
    ...
    vec2 starting_position)
{
    ...
    while (*character != '\0') {
        if (*character != ' ') {
            ...
            Animation *char_anim =
                get(letter_anim_map, (char[]){*character, '\0'});
            animation_render(
                char_anim, window, starting_position, 0, WHITE, texture_slots);
        }
    ...
    vec2_add(
        starting_position, starting_position, (vec2){LETTER_WIDTH * -0.5, 0});
}
...
{
    if (input.down == KS_PRESSED &&
        menu->selected_item < menu->items_count - 1) {
...
void handle_main_menu_input(void)
{
    ...
    default:
        ERROR_EXIT(
            "Got unexpected case on pause menu: %d\n",
