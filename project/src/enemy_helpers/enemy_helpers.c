...
{
    return abs(sqrt(pow((point_a[0] - point_b[0]), 2) + pow(point_a[1] - point_b[1], 2)));
}
...
// updates the statuses, animations, and locations of all enemies in current_enemies each frame
