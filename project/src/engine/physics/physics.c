...
static void update_sweep_result(Hit *result, usize other_id, AABB a, AABB b,
                                vec2 velocity, u8 a_collision_mask,
...
Body *physics_body_create(vec2 position, vec2 size, vec2 velocity,
...
Static_Body *physics_static_body_create(vec2 position, vec2 size,
                                        u8 collision_layer) {
